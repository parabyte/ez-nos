...
struct iface Loopback = {
    ...
    NULLIF,
#endif
	"loopback", /* kpk, altered name loopback to lo     */
    NULLCHAR,   /* description */
    0x7f000001L,    /* addr         127.0.0.1 */
    INADDR_ANY,  /* 0x7fffffffL,*/    /* broadcast 255.255.255.255 changed to 127.255.255.255 to INADDR_ANY */
    0xff000000L,    /* netmask 255.255.255.255 changed to 255.0.0.0 */
...
#ifdef ENCAP
    if(ifp == &Encap) goto drop_routes;  /* n5knx: just drop associated routes */
#endif
    if(ifp == &Loopback)
        return -1;
