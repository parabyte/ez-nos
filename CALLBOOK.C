...
CALLREC *record;
{
    ...
    /* get the callsign */
        if(strlen(fldbuf))record->call = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->last_name = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->title = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->first_name = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->middle_name = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->birth_date = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->license_date = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->expire_date = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->mail_addr1 = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->mail_city = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->mail_state = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->zip = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->location1 = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->location2 = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->location3 = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->license_class = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->prev_call = strdup(fldbuf);
  
        if((tmpbuf = get_field(tmpbuf,fldbuf)) == NULL) break;
        if(strlen(fldbuf))record->prev_class = strdup(fldbuf);
  
        get_field(tmpbuf,fldbuf);
        if(strlen(fldbuf)) record->extra = strdup(fldbuf);
        sts = 0;
    }
